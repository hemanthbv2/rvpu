...
(function() {
  ...
  const suggestionsData = [
    ...
    { text: 'PCMB (Science Stream)', icon: '🔬', query: 'PCMB', tag: 'Science' },
    { text: 'PCMC (Science Stream)', icon: '💻', query: 'PCMC', tag: 'Science' },
    { text: 'BAMS (Commerce Stream)', icon: '📊', query: 'BAMS', tag: 'Commerce' },
    { text: 'BAME (Commerce Stream)', icon: '📈', query: 'BAME', tag: 'Commerce' },
    { text: 'SEBA (Commerce Stream)', icon: '📉', query: 'SEBA', tag: 'Commerce' },
    ...
    { text: 'About RVPU Harohalli & RSST Trust', icon: '🏛️', query: 'about us', tag: 'About' },
