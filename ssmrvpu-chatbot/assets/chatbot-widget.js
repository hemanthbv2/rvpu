 ...
 * Campus: SSMRV Pre-University College, Jayanagar
...
(function() {
  ...
  const WP_REST_URL = "https://ssmrvpu.edu.in/new_ssmrvpu/wp-json/rvpu/v1/telemetry";
  ...
  const suggestionsData = [{"text":"Admission Process & Steps","icon":"📝","query":"admission process","tag":"Admissions"},{"text":"Required Documents for Admission","icon":"📄","query":"required documents","tag":"Admissions"},{"text":"Cutoff Marks & Eligibility Criteria","icon":"🎯","query":"eligibility cutoff","tag":"Admissions"},{"text":"How to Apply post SSLC / 10th","icon":"✍️","query":"how to apply","tag":"Admissions"},{"text":"PCMB (Science Stream)","icon":"🔬","query":"PCMB","tag":"Science"},{"text":"PCMC (Science Stream)","icon":"🔬","query":"PCMC","tag":"Science"},{"text":"SEBA (Commerce Stream)","icon":"📊","query":"SEBA","tag":"Commerce"},{"text":"CEBA (Commerce Stream)","icon":"📊","query":"CEBA","tag":"Commerce"},{"text":"MEBA (Commerce Stream)","icon":"📊","query":"MEBA","tag":"Commerce"},{"text":"PEBA (Commerce Stream)","icon":"📊","query":"PEBA","tag":"Commerce"},{"text":"Science Stream Overview","icon":"🔬","query":"science stream","tag":"Academics"},{"text":"Commerce Stream Overview","icon":"📊","query":"commerce stream","tag":"Academics"},{"text":"JEE Advanced (Main + KCET Decoded)","icon":"🚀","query":"JEE Advanced","tag":"Integrated"},{"text":"JEE (Main + KCET Decoded)","icon":"📐","query":"JEE Main","tag":"Integrated"},{"text":"NEET UG + KCET Medical Track","icon":"🩺","query":"NEET UG","tag":"Medical"},{"text":"Commerce Decoded (CA + CLAT)","icon":"⚖️","query":"Commerce Decoded","tag":"Commerce"},{"text":"Campus Facilities & Photo Tour","icon":"🏫","query":"facilities","tag":"Campus"},{"text":"Science & Computer Laboratories","icon":"🔬","query":"labs","tag":"Campus"},{"text":"Sports Complex, Gym & Pool","icon":"⚽","query":"sports","tag":"Campus"},{"text":"Library & Digital Resource Center","icon":"📚","query":"library","tag":"Campus"},{"text":"Principal & Leadership Desk","icon":"👨‍🏫","query":"principal","tag":"Leadership"},{"text":"About SSMRV PU & RSST Trust","icon":"🏛️","query":"about us","tag":"About"},{"text":"Our 7 Sister Campuses Across Karnataka","icon":"🌐","query":"our campuses","tag":"Campuses"},{"text":"Contact Us & Campus Location","icon":"📍","query":"contact us","tag":"Contact"},{"text":"College Events & Cultural Fests","icon":"🎉","query":"events","tag":"Campus"}];
